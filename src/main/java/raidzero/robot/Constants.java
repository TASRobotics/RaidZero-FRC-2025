...
public class Constants {
    ...
    public class TelescopingArm {
        public class Telescope {
            ...
            //* NUMBERS IN ROTATIONS RIGHT NOW */
            public static final double CONVERSION_FACTOR = 1.0;

            //* NUMBERS IN ROTATIONS RIGHT NOW */
            public static final double MAX_LENGTH_M = 2.0;
            public static final double MIN_LENGTH_M = 0.0; 

            //* TEMP */
            public static final double HOME_POSITION_ROTATIONS = 1.0;
            public static final double TOP_POSITION_ROTATION = 70.0;
            ...
            //TODO: Find these
            public static final double CRUISE_VELOCITY = 110.0;
            public static final double ACCELERATION = 250.0;
