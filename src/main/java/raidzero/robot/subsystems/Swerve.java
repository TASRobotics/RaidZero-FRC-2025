...
public class Swerve extends TunerSwerveDrivetrain implements Subsystem {
    ...
    private void configureAutoBuilder(){
        ...
        try{
            ...
            // Configure AutoBuilder last (partially stolen from https://github.com/CrossTheRoadElec/Phoenix6-Examples/blob/main/java/SwerveWithPathPlanner/src/main/java/frc/robot/subsystems/CommandSwerveDrivetrain.java)
